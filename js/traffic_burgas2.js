...
var mainroad2 = new road(3, mainroadLen, laneWidth, nLanes_main,
      (u) => 70, (u) => -37.5,/*(u) => 70, (u) => -237.5,*/
      density, speedInit, fracTruck, isRing, userCanDistortRoads);
...
var trafficObjs=new TrafficObjects(canvas,1,3,0.60,0.2,3,2);
...
//#################################################################
  ...
  mainroad2.updateTruckFrac(fracTruck, fracTruckToleratedMismatch);
  mainroad2.updateModelsOfAllVehicles(longModelCar,longModelTruck,
				       LCModelCar,LCModelTruck,
				       LCModelMandatory);
...
//##################################################
  ...
  mainroad2.draw(roadImg1,roadImg2,scale,changedGeometry,
		0,mainroad.roadLen,
		movingObserver,uObs,center_xPhys,center_yPhys);
  ...
  mainroad2.drawVehicles(carImg,truckImg,obstacleImgs,scale,
			vmin_col,vmax_col,
			0,mainroad.roadLen,
			movingObserver,uObs,center_xPhys,center_yPhys);
